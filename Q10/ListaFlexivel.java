...
public class ListaFlexivel {   
    public static void main(String[] args)throws Exception{
        ...
        for(int i=0; i<n; i++) { 
            linha = MyIO.readLine();
            String metodo = linha.substring(0, 2); 
            String name = ""; 
            int pos = 0; 
            ...
            if(metodo.compareTo("I*") == 0) {
                ...
                name = linha.substring(6);


            }else if(metodo.compareTo("R*") == 0) {

                pos = Integer.parseInt(linha.substring(3));

                
            }else if(metodo.compareTo("II") == 0 || metodo.compareTo("IF") == 0){

                name = linha.substring(3);
            }
            ...
            if(metodo.compareTo("I*") == 0){
                ...
                movie.ler(name);
                listaFlexivel.inserir(movie, pos); 
                ...
                Filme movie = new Filme();
                movie.ler(name);
                listaFlexivel.inserirInicio(movie);
                ...
                Filme movie = new Filme();
                movie.ler(name);
                listaFlexivel.inserirFim(movie);


                
            }else if(metodo.compareTo("R*") == 0){

                MyIO.println("(R)" + " " + listaFlexivel.remover(pos).getName());//retorna o nome do filme removido em uma posição x

                
            }else if(metodo.compareTo("RI") == 0){

                MyIO.println("(R)" + " " + listaFlexivel.removerInicio().getName()); //retorna o nome do filme removido da primeira posicao

                
            }else if(metodo.compareTo("RF") == 0){

                MyIO.println("(R)" + " " + listaFlexivel.removerFim().getName()); //retorna o nome do filme removido da ultima posição
            }
