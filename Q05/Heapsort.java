...
class Lista {
    ...
    public int getMaiorFilho(int i, int tamHeap){
        int filho;
        if (2*i == tamHeap || array[2*i].getGenre().compareTo(array[2*i+1].getGenre()) > array[2*i+1].getGenre().compareTo(array[2*i].getGenre())){ // 2*i e 2*i+1
           filho = 2*i;
        } else {
           filho = 2*i + 1;
        }
...
public class Heapsort{
    public static void main(String[] args)throws Exception{
        ...
        FileWriter arq = new FileWriter("747560_heapsort.txt");
